...
function llenarProfesores(res){
	...
	res.forEach(rpta=>{
		...
		$('#datos_profesores').append("<tr><td>" +  nombre   + "</td><td>" +  email  + "</td><td><button type='button' class='btn btn-dark text-center' data-toggle='modal' data-target='#modificar_profesores'   onclick='modificar(\"" + clave + "\");'>Modificar</button></td><td><button type='button' class='btn btn-dark text-center'  data-toggle='modal' data-target='#borrar_profesores'  onclick='borrar(\"" + clave + "\");'>Borrar</button></td></tr>");
