...
<body class="is-preload" >
    ...
    <div class="container">
      <h3 align="center">Borrar Avances</h3>  
    </div>
   ...
   <section class="tables" style=" padding-top: 5px; margin-top: 30px;" id="listado_datos">
...
<!---++++++++++++++   tabla de datos     +++++++++++++++-->
    ...
    <div class="modal" tabindex="-1" id="borrar_avance_materia">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Esta seguro de desea borrar sus avances de esta materia</p>
            </div>
  ...
  <script src="JS/App_borrar_avances_materias_movil.js" ></script>
