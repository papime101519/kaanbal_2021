      ...
      <div class="row">
        <div class="col-md-12">
          <div class="section-heading" >
             <center>
            <h2><span id='letrero_nombre_materia'></span></br>
              <span id='letrero_nombre_tema'></span></h2>
            </center>
            <div id="avance" ></div>
          </div>
          ...
          <div class="default-table" style=" padding-top: 0px;">
            <table>
              <thead>
                <tr>
                  <th>Calificaciones por cuestionario:</th>
                </tr>
              </thead>
            ...
            <div class="container-fluid row  ">
                <form class="col-12">
                  <button type="button" class="btn btn-dark col-12" onclick=" window.history.back();">
                    Regresar
                  </button>  
                </form>
          </div>
...
<!---++++++++++++++   tabla de datos     +++++++++++++++-->
      ...
      <div class="modal" tabindex="-1" id="ventana_aviso">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Todavia no ha contestado un cuestionario relacionado con esta tema, Por favor vaya a la sesión de Jugar.</p>
            </div>
            <div class="modal-footer">
  ...
  <script src="JS/App_reporte_por_tema_movil.js" ></script>
