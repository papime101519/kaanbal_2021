...
async  function obtener_usuario(){
    ...
    //     if (user) {
            ...
            await buscar_registros(id_materia,id_usuario);
            await estadisticas_generales_materia(id_materia,id_usuario);
            await listado_cuestionarios_por_materia(id_materia,id_usuario);
