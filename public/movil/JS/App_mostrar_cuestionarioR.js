...
async function mostrar_preguntas(id_pregunta,registros){
    ...
    .then(function(dato) {
        ...
        if (tipo_pregunta==0){
            ...
            if(fila.opcion4!=""){     $('#listado_cuestionarios').append("<br><br><span class='text-success'>Opcion 5: </span> "+fila.opcion4);    }
            if(fila.opcion5!=""){     $('#listado_cuestionarios').append("<br><br><span class='text-success'>Opcion 5: </span> "+fila.opcion5);    }
