...
async function listadoTemas(id_materia){
    ...
    firebase.firestore().collection("lessons").doc(id_materia).collection("Temas").orderBy("num_tema", "asc")
    .get()
    .then(function(querySnapshot) {
        ...
        querySnapshot.forEach(function(rpta) {
           ...
           $('#listado_temas').append("<tr><td>"+num_tema+") " +  nombre  + "</td><td><button type='button' class='btn btn-dark text-center' data-toggle='modal' data-target='#modificar_preguntas'   onclick='contestar_cuestionario(\"" + clave + "\",\"" + nombre + "\");'>Entrar</button></td></tr>"); 
