 ...
 async function avance_por_tema(id_tema,id_usuario){
    ...
    .then(function (querySnapshot) {
        querySnapshot.forEach(function (rpta) {
            ...
            var mensaje="<center><h3><kbd class='text-ligth bg-primary font-weight-bolder  ' >AVANCE: ("+cuestionarios_aprobados+"/"+cuestionarios_temas+" Cuestionarios)  -  CALIFICACION: "+calif_promedio+"</kbd></h3></center>";
            console.log(mensaje);
