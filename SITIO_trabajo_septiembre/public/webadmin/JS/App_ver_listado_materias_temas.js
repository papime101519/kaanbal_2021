...
async function datos_materias_profesores(){
    ...
    .then(res=>{
        ...
        res.forEach(fila=>{
            ...
            $('#datos_materias').append("<tr><td>" +  nombre  + "</td><td><button type='button' class='btn btn-dark text-center'    onclick='moverse_pagina(\"" + idMateria + "\",\""+ nombre +"\");'>Ver temas</button></td></tr>");
...
async function  moverse_pagina(idMateria,nombreMateria){
    window.location.href = "ver_listado_temas.html?id_materia="+idMateria+"&nombreMateria="+nombreMateria; 
}
