...
function listadoPreguntas(materia_seleccionada,tema_seleccionado){
    console.log('id_materia: ' + materia_seleccionada);
    console.log('id_tema: ' + tema_seleccionado);
    var num_registros=0;
    firebase.firestore().collection("questions").where("id_materia", "==", materia_seleccionada).where("id_tema","==",tema_seleccionado)
    .get()
